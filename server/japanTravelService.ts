...
async function generatePlan(model: ReturnType<GoogleGenerativeAI['getGenerativeModel']>, payload: any) {
  ...
  const prompt = `
            ...
            **주요 지침:**
            ...
            3.  **예상 비용 (estimatedCost):** 항공권을 제외한 1인 기준 총 예상 경비를 원화(KRW)로 제시해주세요.
            ...
            7.  **현실적인 항공편 연계:** 여행 시작일과 종료일의 일정은 일반적인 국제선 항공편 운항 시간을 고려하여 현실적으로 작성해주세요. 예를 들어, 인천-일본 노선은 보통 오전 9시 이후 출발, 저녁 8시 이전 도착이 많으므로, 비현실적인 새벽/심야 공항 일정을 포함하지 않도록 주의해주세요.
